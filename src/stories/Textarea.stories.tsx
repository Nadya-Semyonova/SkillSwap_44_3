...
export const Required: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Поле с автоматической валидацией. Ошибка появится, если поле пустое или содержит только пробелы. Попробуйте очистить поле или ввести только пробелы.',
      },
    },
  },
};
...
export const WithText: Story = {
  args: {
    ...
    value: 'Это пример заполненного текстового поля. Здесь может быть любой текст, который пользователь ввел в textarea.',
  },
};
...
export const WithFocus: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Это состояние показывает textarea с автоматическим фокусом. Поле получает фокус при загрузке компонента.',
      },
    },
  },
};
